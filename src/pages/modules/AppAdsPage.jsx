...
import { Megaphone, Search, Plus, Activity } from 'lucide-react';
...
const AppAdsPage = () => {
    ...
    // Mock data for App Ads
    const appAds = [
        { id: 1, campaignName: "Summer Sale 2024", type: "Banner", status: "Active", impressions: "1.2M", clicks: "25K", ctr: "2.08%" },
        { id: 2, campaignName: "New User Welcome", type: "Interstitial", status: "Paused", impressions: "800K", clicks: "15K", ctr: "1.88%" },
        { id: 3, campaignName: "Premium Subscription", type: "Native", status: "Active", impressions: "500K", clicks: "10K", ctr: "2.00%" },
    ];

    const filteredAds = appAds.filter(ad =>
        ad.campaignName.toLowerCase().includes(searchText.toLowerCase()) ||
        ad.type.toLowerCase().includes(searchText.toLowerCase())
    );
        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 pb-12">
            ...
            <div className="rounded-[2rem] mt-8 bg-gradient-to-br from-indigo-800 via-purple-700 to-indigo-900 px-6 sm:px-10 lg:px-12 py-8 sm:py-12 flex items-center min-h-[160px] sm:min-h-[200px] shadow-2xl shadow-indigo-200/50 relative overflow-hidden group">
                ...
                <div className="text-left text-white max-w-2xl relative z-10">
                    ...
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold tracking-tight mb-2">App Advertisements</h1>
                    <p className="text-sm sm:text-base text-purple-100/90 font-medium max-w-lg leading-relaxed">
                        Manage in-app advertisement campaigns, track performance, and optimize revenue.
                    </p>
                </div>
            </div>
            ...
            <div className="mt-8 mb-4">
                <div className="bg-white rounded-2xl border border-gray-100 p-4 shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm font-bold text-gray-700 uppercase tracking-wide">Ad Status:</span>
                    </div>
                    <div className="flex flex-wrap gap-4 text-xs font-medium text-gray-600">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="bg-yellow-100 text-yellow-700 px-2 py-0.5 rounded font-bold">PAUSED</span>
                            <span>- Temporarily stopped</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <span className="w-2 h-2 rounded-full bg-red-500" />
                            <span className="bg-red-100 text-red-700 px-2 py-0.5 rounded font-bold">ENDED</span>
