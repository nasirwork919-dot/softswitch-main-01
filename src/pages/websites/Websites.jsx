...
import { Globe, RefreshCw, Trash2, Plus, Search, Activity } from 'lucide-react';
        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 pb-12">
            ...
            <div className="rounded-[2rem] mt-8 bg-gradient-to-br from-indigo-800 via-purple-700 to-indigo-900 px-6 sm:px-10 lg:px-12 py-8 sm:py-12 flex items-center min-h-[160px] sm:min-h-[200px] shadow-2xl shadow-indigo-200/50 relative overflow-hidden group">
                ...
                <div className="text-left text-white max-w-2xl relative z-10">
                    ...
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold tracking-tight mb-2">Web Sites</h1>
                    <p className="text-sm sm:text-base text-purple-100/90 font-medium max-w-lg leading-relaxed">
                        Manage and monitor your hosted websites and domains.
                    </p>
                </div>
            </div>
            ...
            <div className="bg-white rounded-[2rem] border border-gray-100 shadow-sm p-8 mb-8">
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
                    <h2 className="text-xl font-bold text-gray-900 tracking-tight">Search Websites</h2>
                    <button
            ...
            <div className="bg-white rounded-[2rem] border border-gray-100 shadow-sm p-8 overflow-hidden">
                <h2 className="text-xl font-bold text-gray-900 mb-6">Website List</h2>
                <Table
                    title=""
                    columns={columns}
                    data={websites}
                ...
                {websites.length === 0 && (
                    <div className="text-center py-12">
                        ...
                        <h3 className="text-lg font-bold text-gray-900">No Websites Found</h3>
                        <p className="text-gray-500 text-sm mt-1">Get started by adding a new website.</p>
                    </div>
                )}
            </div>
