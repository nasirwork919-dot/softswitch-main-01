...
import { UserCircle, RefreshCw, Trash2, Plus, Search, Activity, Shield } from 'lucide-react';
import Table from '../../components/common/Table';

const SobAdmin = () => {
    const navigate = useNavigate();
    const [admins, setAdmins] = useState([
        { id: 1, name: "Admin One", email: "admin1@example.com", role: "Super Admin", status: "Active" },
        { id: 2, name: "Admin Two", email: "admin2@example.com", role: "Manager", status: "Inactive" },
    ]);
        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 pb-12">
            ...
            <div className="rounded-[2rem] mt-8 bg-gradient-to-br from-indigo-800 via-purple-700 to-indigo-900 px-6 sm:px-10 lg:px-12 py-8 sm:py-12 flex items-center min-h-[160px] sm:min-h-[200px] shadow-2xl shadow-indigo-200/50 relative overflow-hidden group">
                ...
                <div className="text-left text-white max-w-2xl relative z-10">
                    ...
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold tracking-tight mb-2">Sob Admin</h1>
            ...
            <div className="bg-white rounded-[2rem] border border-gray-100 shadow-sm p-8 mb-8">
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
                    <h2 className="text-xl font-bold text-gray-900 tracking-tight">Search Admins</h2>
                    <button
                        onClick={() => navigate('/sob-admin/add')}
            ...
            <div className="bg-white rounded-[2rem] border border-gray-100 shadow-sm p-8 overflow-hidden">
                <h2 className="text-xl font-bold text-gray-900 mb-6">Admin List</h2>
                <Table
                    title=""
                    columns={columns}
                    data={admins}
                ...
                {admins.length === 0 && (
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-500 text-sm mt-1">Get started by adding a new admin.</p>
                    </div>
                )}
            </div>
