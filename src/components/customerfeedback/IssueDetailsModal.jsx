    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-xl shadow-xl w-full max-w-lg mx-4 p-6">
        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-4 mb-6">
          <div>
            <p className="text-sm text-teal-600 mb-1">Issue ID</p>
          ...
          <div>
            <p className="text-sm text-teal-600 mb-1">Module</p>
            <p className="font-medium text-gray-900">{issue.module}</p>
          </div>
          <div>
            <p className="text-sm text-teal-600 mb-1">Severity</p>
            <p className="font-medium text-gray-900">{issue.severity}</p>
          </div>
          <div>
        ...
        {/* Reported Issue */}
        <div className="mb-6">
          <p className="text-sm text-teal-600 mb-1">Reported Issue</p>
          <p className="text-gray-900">"{issue.reportedIssue || "Payment stuck on checkout and keeps loading."}"</p>
        </div>
