...
const BlockChefModal = ({ isOpen, onClose, chefName, onSubmit }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-xl shadow-xl w-full max-w-md mx-4 p-6">
        ...
        <p className="text-sm text-gray-500 text-center mb-6">
          You are about to block {chefName || "Chef Mariam"} from the Home Food
          Market. When blocked, the chef will not be allowed to receive orders
          or add new dishes until reactivated.
        </p>
